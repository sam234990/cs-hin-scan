...
public:
    ...
    int query_tree(double e_threshold, vector<vector<int>> &res, vector<int> &core_id, int query_type_offset_, vector<vector<int>> &non_core_id);
    void query_tree_only_node(double e_threshold, vector<int> &vertex_res, int query_type_offset_);
